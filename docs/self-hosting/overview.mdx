...
See the [environment variables](/self-hosting/environment-variables) reference for all configuration options. You can also set up [email notifications](/guides/smtp).
