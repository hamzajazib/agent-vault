...
For the basic `docker run` command and first-time setup, see [Deploy Agent Vault](/installation). This page covers Docker-specific configuration, Compose, and image details.
