...
Agent Vault agents follow a standard HTTP protocol to interact with the server. Agents handle this automatically — the canonical reference lives in the [agent skill files](https://github.com/Infisical/agent-vault/blob/main/cmd/skill_http.md), also served at `/v1/skills/http`. This page is a reference for understanding what happens under the hood.
